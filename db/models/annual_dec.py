...
class User(Base):
    ...
    designation = mapped_column(String, nullable=True)
    division = mapped_column(String, nullable=True)
    division_cluster = mapped_column(String, nullable=True)
    organization_vertical = mapped_column(String, nullable=True)
